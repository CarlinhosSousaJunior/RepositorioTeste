...
public class Locacao {
    ...
    public void finalizar(int kmAtual) throws Exception {
        if (kmAtual < this.kmInicial) {
            throw new Exception(" a quilometragem final do veículo não pode ser menor que\n"
